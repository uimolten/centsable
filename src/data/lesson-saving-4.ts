  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'game', image: 'https://picsum.photos/seed/game/200/200', imageHint: 'video game icon', text: 'Video Game' },
            { id: 'bus', image: 'https://picsum.photos/seed/bus/200/200', imageHint: 'bus pass icon', text: 'Bus Pass' },
            { id: 'coffee', image: 'https://picsum.photos/seed/coffee/200/200', imageHint: 'coffee cup icon', text: 'Fancy Coffee' },
            { id: 'backpack', image: 'https://picsum.photos/seed/backpack/200/200', imageHint: 'school backpack', text: 'A new backpack' },
          ],
          correctAnswer: 'bus',
        },
        {
