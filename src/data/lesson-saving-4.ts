  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'game', image: '/images/video-game.png', imageHint: 'video game icon', text: 'Video Game' },
            { id: 'bus', image: '/images/bus-pass.png', imageHint: 'bus pass icon', text: 'Bus Pass' },
            { id: 'coffee', image: '/images/fancy-coffee.png', imageHint: 'coffee cup icon', text: 'Fancy Coffee' },
            { id: 'backpack', image: '/images/backpack.png', imageHint: 'school backpack', text: 'A new backpack' },
          ],
          correctAnswer: 'bus',
        },
        {
