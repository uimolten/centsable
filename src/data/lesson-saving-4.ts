  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'game', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'video game icon', text: 'Video Game' },
            { id: 'bus', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'bus pass icon', text: 'Bus Pass' },
            { id: 'coffee', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'coffee cup icon', text: 'Fancy Coffee' },
            { id: 'backpack', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'school backpack', text: 'A new backpack' },
          ],
          correctAnswer: 'bus',
        },
        {
