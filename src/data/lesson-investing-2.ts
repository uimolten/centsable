  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'tech', text: 'A new, unproven tech company stock ⚔️' },
            { id: 'bond', text: 'A bond from the U.S. government 🛡️' },
            { id: 'savings', text: 'A high-yield savings account' },
            { id: 'mutual', text: 'A diversified mutual fund' },
          ],
          correctAnswer: 'tech',
