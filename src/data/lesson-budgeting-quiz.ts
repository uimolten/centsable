  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          correctAnswer: 'Want',
          reinforcement: "Correct! These are fun but optional.",
        },
        {
          type: 'multiple-choice',
        ...
        },
        {
          ...
          options: [
            { id: 'opt1', text: 'Concert Tickets', image: '/images/concert-tickets.webp', imageHint: 'concert tickets' },
            { id: 'opt2', text: 'Bus Pass', image: '/images/bus-pass.webp', imageHint: 'bus pass' },
            { id: 'opt3', text: 'New Phone Case', image: '/images/phone-case.webp', imageHint: 'phone case' },
            { id: 'opt4', text: 'Fancy Dinner', image: '/images/fancy-dinner.webp', imageHint: 'fancy dinner' },
          ],
          correctAnswer: 'opt2',
        },
        {
