  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'opt1', text: 'Concert Tickets', image: '/images/concert-tickets.png', imageHint: 'concert tickets' },
            { id: 'opt2', text: 'Bus Pass', image: '/images/bus-pass.png', imageHint: 'bus pass' },
            { id: 'opt3', text: 'New Phone Case', image: '/images/phone-case.png', imageHint: 'phone case' },
            { id: 'opt4', text: 'Fancy Dinner', image: '/images/fancy-dinner.png', imageHint: 'fancy dinner' },
          ],
          correctAnswer: 'opt2',
        },
        {
