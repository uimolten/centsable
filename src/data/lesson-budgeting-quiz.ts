  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'opt1', text: 'Concert Tickets', image: 'https://picsum.photos/seed/concert/200/200', imageHint: 'concert tickets' },
            { id: 'opt2', text: 'Bus Pass', image: 'https://picsum.photos/seed/buspass/200/200', imageHint: 'bus pass' },
            { id: 'opt3', text: 'New Phone Case', image: 'https://picsum.photos/seed/phonecase/200/200', imageHint: 'phone case' },
            { id: 'opt4', text: 'Fancy Dinner', image: 'https://picsum.photos/seed/fancydinner/200/200', imageHint: 'fancy dinner' },
          ],
          correctAnswer: 'opt2',
        },
        {
