  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'opt1', text: '🍔 Lunch ($10)', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'hamburger' },
            { id: 'opt2', text: '🎮 Game Skin ($5)', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'game controller skin' },
            { id: 'opt3', text: '🚌 Bus Fare ($2)', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'bus fare ticket' },
            { id: 'opt4', text: 'Compliment from a friend', image: 'https://placehold.co/200x200/0A0A0A/4ADE80', imageHint: 'friendly chat' },
          ],
