  ...
  modules: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          options: [
            { id: 'opt1', text: '🍔 Lunch ($10)', image: 'https://placehold.co/200x200', imageHint: 'hamburger' },
            { id: 'opt2', text: '🎮 Game Skin ($5)', image: 'https://placehold.co/200x200', imageHint: 'game controller skin' },
            { id: 'opt3', text: '🚌 Bus Fare ($2)', image: 'https://placehold.co/200x200', imageHint: 'bus fare ticket' },
