...
export const units: Unit[] = [
  ...
  },
  {
    ...
    unitIcon: PieChart,
    activities: [
      { id: 'b1', title: 'Why Budgeting Matters', type: 'lesson', state: 'active', xp: 40 },
      { id: 'b2', title: "Where's Your Money Really Going?", type: 'lesson', state: 'active', xp: 70 },
      { id: 'b3', title: 'Building Your First Budget: The 50/30/20 Rule', type: 'lesson', state: 'active', xp: 60 },
      { id: 'b4', title: 'Sticking to Your Budget', type: 'lesson', state: 'active', xp: 80 },
      { id: 'b5', title: 'Connecting Budgets to Goals', type: 'lesson', state: 'active', xp: 80 },
      { id: 'bp1', title: 'Practice: The 50/30/20 Rule', type: 'practice', state: 'active', xp: 40 },
      { id: 'bp2', title: 'Practice: Adjusting Your Budget', type: 'practice', state: 'active', xp: 40 },
