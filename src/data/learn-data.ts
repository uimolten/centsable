...
export const units: Unit[] = [
  {
    ...
    activities: [
      ...
      { id: 's2', title: 'Creating a Savings Goal', type: 'lesson', state: 'active', xp: 75 },
      { id: 's3', title: 'Practice: Savings Goals', type: 'practice', state: 'active', xp: 40 },
      { id: 's4', title: 'Saving Unit Quiz', type: 'quiz', state: 'active', xp: 100 },
    ],
  },
  {
    id: 'unit-2',
    ...
    unitIcon: PieChart,
    activities: [
      { id: 'b1', title: 'Why Budgeting Matters', type: 'lesson', state: 'active', xp: 50 },
      { id: 'b2', title: 'Tracking Income & Expenses', type: 'lesson', state: 'active', xp: 60 },
      { id: 'bp1', title: 'Practice: Tracking Your Money', type: 'practice', state: 'active', xp: 40 },
      { id: 'b3', title: 'Building a Budget', type: 'lesson', state: 'active', xp: 70 },
      { id: 'b4', title: 'Sticking to Your Budget', type: 'lesson', state: 'active', xp: 70 },
      { id: 'bp2', title: 'Practice: Budget Scenarios', type: 'practice', state: 'active', xp: 40 },
      { id: 'b5', title: 'Budgeting for Goals', type: 'lesson', state: 'active', xp: 80 },
      { id: 'bq1', title: 'Budgeting Unit Quiz', type: 'quiz', state: 'active', xp: 100 },
    ],
  },
  {
    id: 'unit-3',
