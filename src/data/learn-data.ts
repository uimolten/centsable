...
const rawUnitsData: Unit[] = [
  ...
  },
  {
    ...
    unitIcon: PieChart,
    activities: [
      { id: 'b1', title: 'Why Budgeting Matters', type: 'lesson', state: 'locked', xp: 5 },
      { id: 'b2', title: 'Tracking Income & Expenses', type: 'lesson', state: 'locked', xp: 7 },
      { id: 'bp1', title: 'Practice: Tracking Your Money', type: 'practice', state: 'locked', xp: 15 },
      { id: 'b3', title: 'Building a Budget', type: 'lesson', state: 'locked', xp: 8 },
      { id: 'b4', title: 'Sticking to Your Budget', type: 'lesson', state: 'locked', xp: 8 },
      { id: 'bp2', title: 'Practice: Budget Scenarios', type: 'practice', state: 'locked', xp: 15 },
      { id: 'b5', title: 'Budgeting for Goals', type: 'lesson', state: 'locked', xp: 10 },
  ...
  },
  {
    ...
    activities: [
      { id: 'ui1', title: 'What is Insurance?', type: 'lesson', state: 'locked', xp: 5 },
