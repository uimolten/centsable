...
const rawUnitsData: Unit[] = [
  ...
  },
  {
    ...
    unitIcon: PieChart,
    activities: [
      { id: 'b1', title: 'Where Does Your Money Go?', type: 'lesson', state: 'locked', xp: 50 },
      { id: 'b2', title: 'The 50/30/20 Rule', type: 'lesson', state: 'locked', xp: 70 },
      { id: 'b3', title: 'Building Your Game Plan', type: 'lesson', state: 'locked', xp: 70 },
      { id: 'b4', title: 'Staying in the Game', type: 'lesson', state: 'locked', xp: 50 },
      { id: 'bp1', title: 'Practice: The Budget Allocator', type: 'practice', state: 'locked', xp: 80 },
