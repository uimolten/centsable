        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <GlassCard className="md:col-span-2 lg:col-span-2">
            ...
            <div className="mt-6 aspect-video rounded-lg overflow-hidden relative bg-black/20">
              <Image src="https://placehold.co/800x450" alt="Interactive Learning Mockup" layout="fill" objectFit="cover" data-ai-hint="lesson screen" className="opacity-75" sizes="(min-width: 1024px) 50vw, (min-width: 768px) 66vw, 100vw" />
            </div>
          </GlassCard>
          <GlassCard>
            ...
            <p className="mt-2 text-muted-foreground">Put your skills to the test with games that make learning stick.</p>
             <div className="mt-6 grid grid-cols-2 gap-4">
               <div className="aspect-square rounded-lg overflow-hidden relative bg-black/20">
                  <Image src="https://placehold.co/400x400" alt="Minigame 1" layout="fill" objectFit="cover" data-ai-hint="block game" className="opacity-75" sizes="(min-width: 1024px) 15vw, (min-width: 768px) 25vw, 50vw" />
               </div>
               <div className="aspect-square rounded-lg overflow-hidden relative bg-black/20">
                  <Image src="https://placehold.co/400x400" alt="Minigame 2" layout="fill" objectFit="cover" data-ai-hint="finance game" className="opacity-75" sizes="(min-width: 1024px) 15vw, (min-width: 768px) 25vw, 50vw" />
               </div>
            </div>
          </GlassCard>
          <GlassCard>
            ...
            <div className="mt-6 aspect-square rounded-lg overflow-hidden relative bg-black/20">
              <Image src="https://placehold.co/400x400" alt="Quiz Mockup" layout="fill" objectFit="cover" data-ai-hint="quiz interface" className="opacity-75" sizes="(min-width: 1024px) 33vw, (min-width: 768px) 50vw, 100vw" />
            </div>
          </GlassCard>
          <GlassCard className="md:col-span-2 lg:col-span-2">
            ...
            <div className="mt-6 aspect-video rounded-lg overflow-hidden relative bg-black/20">
              <Image src="https://placehold.co/800x450" alt="Progress Tracking Mockup" layout="fill" objectFit="cover" data-ai-hint="dashboard chart" className="opacity-75" sizes="(min-width: 1024px) 50vw, (min-width: 768px) 66vw, 100vw" />
            </div>
          </GlassCard>
        </div>
      </motion.div>
